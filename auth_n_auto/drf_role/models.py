...
class Role(models.Model):
    ...
    description = models.TextField(
        verbose_name='Role\'s Description', blank=True
    )
...
class Permission(models.Model):
    access_type = models.IntegerField(
        default=PermissionEnum.READ.value, unique=True
    )
    access_type_name = models.CharField(
        max_length=20, default=PermissionEnum.READ.name
    )
